...
module.exports.PDFDisapproved = function(
  path,
  id,
  canonAux,
  logoPath,
  ...
  return new Promise(resolve => {
    const pdf = new PDFDocument({
      ...
      info: {
        Title: 'Solicitud de Canon Desaprobada',
        Author:
    ...
    pdf
      ...
      .font('Helvetica');
    pdf.text(
      'Se informa por el siguiente comprobante, que desde' +
        ' el departamento de Registro Gráfico y Fiscalización' +
        ' perteneciente a la Dirección Provincial de Minería,' +
        ' se procede a DESAPROBAR la solicitud de liquidación de canon' +
        ' de los periodos:',
      40,
      195
    );
